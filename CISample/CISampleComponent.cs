...
namespace CISample
{
    public class CISampleComponent : GH_Component
    {
        ...
        {
            pManager.AddNumberParameter("Result","R", "R", GH_ParamAccess.item);
        }
        ...
        {
            get { return new Guid("2a22d638-5549-4caa-b964-0105750dc389"); }
        }
    }
}
